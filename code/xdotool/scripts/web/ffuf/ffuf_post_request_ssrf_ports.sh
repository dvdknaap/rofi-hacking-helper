...
: '
ffuf: : do a post request with given post data, wordlist and filter to check ports (SSRF)
'
...
POST_DATA_FIELD=$(form_item "post data" "post_data" "param1=http://127.0.0.1:FUZZ/&")
