...
POST_DATA_FIELD=$(form_item "post data" "post_data" "param1=http://localhost/FUZZEXT&")
FILTER_TEXT_FIELD=$(form_item "filter response text" "filter_text" "Server at domain.tld Port 80")
