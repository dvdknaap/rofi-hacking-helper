...
paste_command "dnsenum --dnsserver ${DNS_SERVER_IP} --enum -p 0 -s 0 -o ${OUTPUT_FILE_FIELD} -f /usr/share/seclists/Discovery/DNS/subdomains-top1million-110000.txt ${DOMAIN}"
xdotool key Return
