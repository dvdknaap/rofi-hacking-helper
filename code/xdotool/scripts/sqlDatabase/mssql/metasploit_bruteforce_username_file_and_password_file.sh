...
SRC_FILE="${FILES_FOLDER}/msfconsole_brute_force_mssql_user_file_pass_file.rc"
TMP_FILE="${FILES_FOLDER}/msfconsole_brute_force_mssql_user_file_pass_file_temp.rc"
