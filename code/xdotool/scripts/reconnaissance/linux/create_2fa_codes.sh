...
: '
create 2FA codes and save to file
'

# Generate GUI form items (label, type (optional: default text), name, default (optional))
SEQUENCE_START_FIELD=$(form_item  "sequence start" "number" "sequence_start" "0")
SEQUENCE_END_FIELD=$(form_item  "sequence end" "number" "sequence_end" "9999")
EQUAL_WIDTH_FIELD=$(form_item  "equal lengths" "select" "equal_lengths" "yes" "no|yes")
OUTPUT_FILE_FIELD=$(form_item  "output file" "output_file" "2fa_codes.txt")
